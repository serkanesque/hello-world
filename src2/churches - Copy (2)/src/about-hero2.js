...
class AboutHero extends PolymerElement {
  static get template() {
    return html`
...
#hero {
  ...
  background-image: url('./src/images/about-hero.png');
...
<div>  
                ...
                <div>
                <h5>The Issue</h5>
                <h2 class="large-headline">We were formed to broaden religious support for law reform to end corporal punishment of children and to challenge faith-based justification for it.</h2>
                <a href="#">Read more</a>
                </div>
                </div>         
              </div>
...
window.customElements.define('about-hero', AboutHero);
