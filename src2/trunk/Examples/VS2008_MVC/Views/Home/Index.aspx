<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="UFrame2008.Views.Home.Index" %>
...
<head id="Head1" runat="server">
    ...
    <script src="/UFrameMVC/Content/Javascripts/htmlparser.js" type="text/javascript"></script>
    <script src="/UFrameMVC/Content/Javascripts/UFrame.js" type="text/javascript"></script>
    ...
    <style type="text/css">
        ...
        div.UFrame { width: 300px; height: 300px;border: 1px solid black; background-color: white; color:black; padding: 5px }
...
<body >
    ...
    <fieldset class="testarea">
        <div class="box">
            ...
            <p class="description">An URL names /SomePage/ABC/View is loaded inside a DIV. You can click on the buttons and see the page postbacks within the DIV just like an IFRAME. </p>
            ...
            &lt;div class="UFrame" id="UFrame1" src="SomePage/ABC/View" &gt;&lt;/div&gt;</p>
        </div>
        
        <div class="box">
            <div class="no">2.</div>
            <h3>Load pages like widgets</h3>
            <p class="description">Another instance of /SomePage/BCD/View is loaded inside a DIV. This shows same view can be loaded many times within the same parent page. </p>
            <div class="UFrame" id="UFrame2" src="SomePage/BCD/View/Bill/Gates/50" progressTemplate="<h1>Loading...</h1>">
                <p>This should get replaced with content from SomePAge/BCD/View</p>
            </div>
            <p class="description">THIS IS NOT AN IFRAME<br />
            &lt;div class="UFrame" id="UFrame2" src="SomePage/BCD/View" progressTemplate="&lt;h1&gt;Loading...&lt;/h1&gt;"&gt;<br />
            &lt;/div&gt;</p>
        </div>
        ...
        <div class="box">
            ...
            <p class="description">Following loads Flickr photos and pages through them. It shows a typical ASP.NET MVC Paging approach.</p>
            <div class="UFrame" id="TestPage" src="AnotherPage/View" progressTemplate="&lt;p&gt;Loading...&lt;/p&gt;">
                <p>Loading Flickr Photos...</p>
            </div>
            <p class="description">THIS IS NOT AN IFRAME<br />
            &lt;div class="UFrame" id="TestPage" src="AnotherPage/View" &gt;<br />
            &lt;/div&gt;
            </p>
        </div>
    </fieldset>
