...
url = "https://www.soccerstats.com/halftime.asp?league=denmark"
driver.get(url)
soup = BeautifulSoup(driver.page_source)
div = soup.find_all("div", class_="tabberlive")
table = div[3].find_all("table")
f = open("denmark1/halfTimeAwayTrailing.txt", "w")
f.write(str(table[2]))
f.close()
...
div = soup.find_all("div", class_="tabberlive")
table = div[3].find_all("table")
f = open("denmark1/halfTimeHomeTrailing.txt", "w")
f.write(str(table[1]))
f.close()
...
f = open("denmark1/halfTimeHomeLeading.txt", "w")
f.write(str(table[1]))
f.close()
...
div = soup.find_all("div", class_="tabberlive")
table = div[2].find_all("table")
f = open("denmark1/halfTimeAwayLeading.txt", "w")
f.write(str(table[2]))
f.close()
...
url = "https://www.soccerstats.com/timing.asp?league=denmark"
time.sleep(2)
driver.get(url)
soup = BeautifulSoup(driver.page_source)
div = soup.find_all("div", class_="tabberlive")
table = div[0].find_all("table")
f = open("denmark1/homeGoals.txt", "w")
f.write(str(table[1]))
f.close()
...
div = soup.find_all("div", class_="tabberlive")
table = div[0].find_all("table")
f = open("denmark1/awayGoals.txt", "w")
f.write(str(table[2]))
f.close()
counter +=1
print(str(counter) + " out of " + str(total))
...
f = open("denmark1/homeRows.txt", "w")
f.write(str(table))
f.close()
...
url = "https://www.soccerstats.com/results.asp?league=denmark_2019&pmtype=bydate"
data = requests.get(url,time.sleep(2))
soup = BeautifulSoup(data.content)
div = soup.find("div", class_="six columns")
table = soup.find("table", id="btable")
f = open("denmark1/seasonFixtures2018.txt", "w")
f.write(str(table))
f.close()
