...
counter = 0
total = 11
url = "https://www.soccerstats.com/halftime.asp?league=germany"
driver.get(url)
...
url = "https://www.soccerstats.com/homeaway.asp?league=germany"
...
url = "https://www.soccerstats.com/results.asp?league=germany&pmtype=bygameweek"
data = requests.get(url,time.sleep(1))
soup = BeautifulSoup(data.content)
...
url = "https://www.soccerstats.com/results.asp?league=germany&pmtype=bydate"
data = requests.get(url,time.sleep(1))
soup = BeautifulSoup(data.content)
...
url = "https://www.soccerstats.com/results.asp?league=germany_2019&pmtype=bydate"
data = requests.get(url,time.sleep(1))
soup = BeautifulSoup(data.content)
