...
class WhyProhibitCorporalPunishment extends PolymerElement {
  static get template() {
    return html`
    ...
    <div class="div-block-4 narrow">
      ...
      <div class="div-block-12">
        <div class="w-layout-grid grid issue double">
          ...
          <a href="[[rootPath]]view8/religion-and-corporal-punishment-of-children" class="link-block-2 w-inline-block">
...
ready() {
  ...
  super.ready();
db.collection("issue").where("title", "==", "why-prohibit-corporal-punishment").get().then((snapshot) => {  
...
window.customElements.define('why-prohibit-corporal-punishment', WhyProhibitCorporalPunishment);
